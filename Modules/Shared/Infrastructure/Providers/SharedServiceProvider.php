...
class SharedServiceProvider extends ServiceProvider
{
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path($this->moduleName, 'Infrastructure/Adapter/In/Web/HttpResources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path($this->moduleName, 'Infrastructure/Adapter/In/Web/HttpResources/lang'), $this->moduleNameLower);
            $this->loadJsonTranslationsFrom(module_path($this->moduleName, 'Infrastructure/Adapter/In/Web/HttpResources/lang'), $this->moduleNameLower);
        }
    }
